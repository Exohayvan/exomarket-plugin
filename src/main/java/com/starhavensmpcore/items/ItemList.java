...
public final class ItemList {
    ...
    static {
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                new DropTable("aluminum_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("chromium_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("raw_cobalt", 1, 4, true),
                new DropTable("cobalt_ore", 1, 1),
                0,
                0,
                null
        ));
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("nether_obsidan_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("platinum_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("raw_tin", 2, 5, true),
                new DropTable("tin_ore", 1, 1),
                0,
                0,
                new GenerationRules(
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("raw_tin_block", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("cobalt_block", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("raw_cobalt_block", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("titanium_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("tungsten_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("vanadium_ore", 1, 1),
                null,
                0,
                0,
                null
        ...
        register(all, customBlocks, generationBlocks, byId, new BlockDefinition(
                ...
                ToolRequirement.IRON_PICKAXE_OR_BETTER,
                new DropTable("void_shard", 1, 1, true),
                new DropTable("voidstone_ore", 1, 1),
                12,
                20,
                new GenerationRules(
